<template>
  <section class="container mx-auto p-6 mb-6">
          ...
          <router-link :to="'/blog/post/' + post.slug">
            <div class="p-6 relative h-full flex flex-col">
              ...
              <div class="flex items-center flex-wrap mt-auto">
                ...
                >
                  Weiterlesen<i
                    class="fa-solid fa-arrow-right ml-2 self-center"
                  ></i>
                </span>
                <span
                  class="
    ...
    <div v-else>
        <p><i class="fa-solid fa-triangle-exclamation mr-3 text-rose-500"></i>Es sind noch keine Blog Beiträge vorhanden.</p>
    </div>
  </section>
</template>
...
export default {
  ...
  mounted() {
    fetch("http://192.168.2.106/janikrabenstein.de.api/get_blog_posts.php")
      .then((res) => res.json())
