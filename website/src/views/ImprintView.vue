<template>
  <div class="container mx-auto p-6 mb-6">
    <h1 class="font-bold text-5xl mb-12">Impressum.</h1>
    ...
    <a rel="noopener" target="_blank" class="text-primary hover:text-primary-hover"
      href="https://www.kanzlei-hasselbach.de/">Kanzlei Hasselbach, Rechtsanwälte für Arbeitsrecht und Familienrecht</a>  </div>
</template>
