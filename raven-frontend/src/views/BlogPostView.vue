...
export default {
    ...
    created() {
        fetch('http://192.168.2.106/janikrabenstein.de.api/get_blog_post.php?slug=' + this.$route.params.slug )
        .then(res => res.json())
        .then(data => this.post = data)
        .catch(error => console.log(error.message))

        fetch('http://192.168.2.106/janikrabenstein.de.api/get_tags.php')
        .then(res => res.json())
